...
<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  <tr>
    ...
    <td><a href="<?php echo e(route('admin.product.review.detail',$row->product_id)); ?>"><?php echo e($row->name); ?> <i class="icon nav-icon" data-feather="arrow-right"></i> </a></td>
    <td><?php echo e(totalReviews($row->product_id)); ?></td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u336648322/domains/computronicsmultivision.com/public_html/core/resources/views/admin/product_review/index.blade.php ENDPATH**/ ?>