...
<form action="<?php echo e(route('product.import')); ?>" method="post" enctype="multipart/form-data">
  <?php echo csrf_field(); ?>
...
<!-- Modal body -->
<div class="modal-body">
<form action="<?php echo e(route('identify.product.import')); ?>" method="post" enctype="multipart/form-data">
  <?php echo csrf_field(); ?>
...
</div><?php /**PATH /home/u336648322/domains/computronicsmultivision.com/public_html/core/resources/views/admin/layouts/footer-copyright.blade.php ENDPATH**/ ?>