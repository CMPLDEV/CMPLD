...
<?php $__env->startSection('title','Product Negotiation'); ?>
...
<hr>
<form action="<?php echo e(route('product.negotiation.bottom.action')); ?>" method="GET" onSubmit="return checkboxValidation()">
 <?php echo csrf_field(); ?> 
...
<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  <tr>
    ...
    <td width="250"> <a href="<?php echo e(productURL(Str::slug($row->name))); ?>" target="_blank"><?php echo e($row->name); ?></a> </td>

    <td> <?php echo e($row->product_found_on); ?> </td>
    
    <td> <a href="mailto:<?php echo e($row->email); ?>"><?php echo e($row->email); ?></a> </td>
    
    <td> <a href="tel:<?php echo e($row->mobile); ?>"><?php echo e($row->mobile); ?></a> </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u336648322/domains/computronicsmultivision.com/public_html/core/resources/views/admin/product-negotiation.blade.php ENDPATH**/ ?>