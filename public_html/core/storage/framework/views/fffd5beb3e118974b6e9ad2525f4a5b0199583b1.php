...
<?php if(!empty($page->banner)): ?>   
 <div class="ban-img position-relative">
     ...
     <div class="img-text position-absolute top-50 start-50 translate-middle">
         <span class="fs-2 fw-bold text-white">Our Partner</span>
     </div>
...
<div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-6 mb-4">
    <div class="cc_bx">
 <img src="uploaded_files/our_partner/<?php echo e($row->image); ?>" alt="<?php echo e(setting()->comp_name); ?>" />
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u336648322/domains/computronicsmultivision.com/public_html/core/resources/views/our-partner.blade.php ENDPATH**/ ?>