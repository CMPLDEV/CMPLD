...
<?php $__env->startSection('title','Showcase Listing'); ?>
...
<div class="row">
 ...
 <div class="col-lg-4">
 <a href="<?php echo e(route('showcase.add')); ?>" class="float-end btn btn-primary btn-sm" data-bs-toggle="tooltip" title="Add New"> <i class="icon nav-icon" data-feather="plus"></i> Add New </a>
...
<hr>
<form action="<?php echo e(route('showcase.bottom.action')); ?>" method="GET" onSubmit="return checkboxValidation()">
 <?php echo csrf_field(); ?> 
...
?>
  <tr>
    ...
    <td><img src="<?php echo e(asset(showImage($row->banner,'uploaded_files/showcase'))); ?>" alt="<?php echo e($row->name); ?>" width="100" class="rounded">
    <a href="<?php echo e(route('showcase.product',$row->id)); ?>"> <?php echo e($row->name); ?> <i class="fas fa-arrow-right"></i> </a> 
    </td>
    ...
    <td>
    <a href="<?php echo e(route('showcase.update.status',[$row->id,$row_st])); ?>" onClick="return confirm('Are you sure?');"><?php echo statusBadge($row->status); ?></a>
    </td>
    <td>
      <a href="<?php echo e(route('showcase.edit',$row->id)); ?>" data-bs-toggle="tooltip" title="Edit"><i class="icon nav-icon" data-feather="edit"></i></a>
    </td>
  </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u336648322/domains/computronicsmultivision.com/public_html/core/resources/views/admin/showcase/index.blade.php ENDPATH**/ ?>