...
<?php $__env->startSection('title','Showcase Product'); ?>
...
<h4 class="mb-0">Showcase Product for "<?php echo e($showcase->name); ?>"</h4>

<div class="page-title-right">
<ol class="breadcrumb m-0">
<li class="breadcrumb-item"></li>  
<li class="breadcrumb-item"><a href="">Dashboard</a></li>
<li class="breadcrumb-item active">Showcase Product</li>
</ol>
</div>
...
<div class="row">
 ...
 <a href="<?php echo e(route('showcase')); ?>" class="btn btn-info btn-sm text-white">Back</a>

 <a href="<?php echo e(route('showcase.product.add', $showcase->id)); ?>" class="float-end btn btn-primary btn-sm" data-bs-toggle="tooltip" title="Add New"> <i class="icon nav-icon" data-feather="plus"></i> Add New </a>
...
<hr>
<form action="<?php echo e(route('showcase.product.bottom.action')); ?>" method="GET" onSubmit="return checkboxValidation()">
 <?php echo csrf_field(); ?> 
<table class="table table-bordered">
<thead>
  <tr>
    <th scope="col"><input type="checkbox" id="checkAll"> S.No</th>
    <th scope="col">Showcase Product</th>
...
?>
  <tr>
    ...
    <td>
    <a href="<?php echo e(route('showcase.product.update.status',[$row->id,$row_st])); ?>" onClick="return confirm('Are you sure?');"><?php echo statusBadge($row->status); ?></a>
    </td>
  </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u336648322/domains/computronicsmultivision.com/public_html/core/resources/views/admin/showcase/showcase-product.blade.php ENDPATH**/ ?>