...
<div class="row">
 ...
 <a href="<?php echo e(route('subscription.bulk')); ?>" class="float-end btn btn-primary btn-sm" data-bs-toggle="tooltip" title="Add New"> <i class="ri-add-circle-line"></i> Make Bulk Enquiry</a> 
<?php endif; ?>
</div> 
</div>
</div>
...
<?php if($data->isNotEmpty()): ?>
<hr>
<form action="<?php echo e(route('subscription.bottom.action')); ?>" method="GET" onSubmit="return checkboxValidation()">
 <?php echo csrf_field(); ?> 
...
<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  <tr>
    ...
    <td>
      <p> 
      <?php if(!empty($row->name)): ?> <i class="fas fa-user"></i> <?php echo e($row->name); ?> <br> <?php endif; ?>
       <i class="fas fa-envelope"></i> <?php echo e($row->email); ?> <br>
      </p>
    </td>
    <td><?php echo subscriptionBadge($row->status); ?></td>
  </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u336648322/domains/computronicsmultivision.com/public_html/core/resources/views/admin/subscription.blade.php ENDPATH**/ ?>