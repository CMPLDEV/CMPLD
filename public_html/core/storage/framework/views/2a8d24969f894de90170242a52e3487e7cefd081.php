...
<div class="row">
 ...
 <div class="col-lg-3">
 <a href="<?php echo e(route('testimonial.add')); ?>" class="float-end btn btn-primary btn-sm" data-bs-toggle="tooltip" title="Add New"> <i class="ri-add-circle-line"></i> Add new</a>
</div> 
</div>
</div>
...
<hr>
<form action="<?php echo e(route('testimonial.bottom.action')); ?>" method="GET" onSubmit="return checkboxValidation()">
 <?php echo csrf_field(); ?> 
...
?>
  <tr>
    ...
    <td>
    <img src="<?php echo e(asset(showImage($row->image,'uploaded_files/testimonial'))); ?>" alt="<?php echo e($row->name); ?>" width="50" class="rounded">
    <?php echo e($row->name); ?></td>
    ...
    <td><a href="<?php echo e(route('testimonial.update.status',[$row->id,$row_st])); ?>" onClick="return confirm('Are you sure?');"><?php echo statusBadge($row->status); ?></a></td>
    <td>
      <a href="<?php echo e(route('testimonial.edit',$row->id)); ?>" data-bs-toggle="tooltip" title="Edit"><i class="icon nav-icon" data-feather="edit"></i></a>
    </td>
  </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u336648322/domains/computronicsmultivision.com/public_html/core/resources/views/admin/testimonial.blade.php ENDPATH**/ ?>