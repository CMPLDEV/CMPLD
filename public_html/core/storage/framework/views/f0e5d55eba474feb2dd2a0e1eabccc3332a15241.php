...
<?php $__env->startSection('title','Add/Edit Blog'); ?>
...
<div class="card">
<div class="card-body">
<h5 class="card-title"><?php if(isset($edit)): ?> Edit <?php else: ?> Add <?php endif; ?> Blog
<a href="<?php echo e(route('admin.blog')); ?>" class="btn btn-info btn-sm float-end text-white">Back</a></h5>

<hr>

<form method="post" enctype="multipart/form-data" <?php if(isset($edit)): ?> action="<?php echo e(route('blog.update',$edit->id)); ?>" <?php else: ?> action="<?php echo e(route('blog.create')); ?>" <?php endif; ?>>
 <?php echo csrf_field(); ?>
...
<div class="col-lg-3">
 <?php if(isset($edit) && !empty($edit->image)): ?>
  <img src="<?php echo e(asset(showImage($edit->image,'uploaded_files/blog'))); ?>" alt="image" width="100%">
...
<div class="col-lg-9">
 <?php if(isset($edit) && !empty($edit->banner)): ?>
  <img src="<?php echo e(asset(showImage($edit->banner,'uploaded_files/blog'))); ?>" alt="image" width="100%">
   <br> <a href="<?php echo e(route('blog.remove.image',[$edit->id,'banner'])); ?>" class="text-danger">Remove</a>
 <?php else: ?> 
...
unset($__errorArgs, $__bag); ?>
  ...
  <div class="col-sm-2">
  <input type="checkbox" name="is_news" id="is_news" <?php if(isset($edit)): ?> <?php if($edit->is_news): ?> checked <?php endif; ?> <?php endif; ?> />    
...
unset($__errorArgs, $__bag); ?>" id="floatingInput" name="alt" placeholder="Image Alt" <?php if(isset($edit)): ?> value="<?php echo e($edit->alt); ?>" <?php else: ?> value="<?php echo e(old('alt')); ?>" <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>" id="floatingInput" name="title" placeholder="Image Title" <?php if(isset($edit)): ?> value="<?php echo e($edit->title); ?>" <?php else: ?> value="<?php echo e(old('title')); ?>" <?php endif; ?>>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/laravel/website/computronicsmultivision.com/core/resources/views/admin/addedit-blog.blade.php ENDPATH**/ ?>