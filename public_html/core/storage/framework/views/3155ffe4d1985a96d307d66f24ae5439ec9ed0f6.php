<?php if($best_categories->isNotEmpty()): ?>
 <?php $__currentLoopData = $best_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<span class="p-subtitle p-subtitle-2">Explore <?php echo e($cat->name); ?></span>
<h3 class="p-title pb-15 mb-0">Best Products</h3>
<?php else: ?>
 <a href="<?php echo e(categoryURL($cat->slug)); ?>" class="cat_banner"> <img src="uploaded_files/category/<?php echo e($cat->banner); ?>" title="<?php echo e(setting()->comp_name); ?>" alt="<?php echo e(setting()->comp_name); ?>" width="100%" /> </a>
<?php endif; ?>
</div>
</div>
</div>
...
<?php $__currentLoopData = productsByCategory($cat->id,1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<div class="p-btn p-btn-1 wow fadeInUp" data-wow-delay="1.2s">
 <a href="<?php echo e(categoryURL($cat->slug)); ?>">View All</a>
</div>
</div>
</div>
</div>
 ...
 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?><?php /**PATH /home/laravel/website/computronicsmultivision.com/core/resources/views/index-best-product.blade.php ENDPATH**/ ?>