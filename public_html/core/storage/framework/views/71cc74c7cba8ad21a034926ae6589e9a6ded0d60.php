...
<img src="<?php echo e(showImage($page->image,'uploaded_files/page')); ?>" alt="<?php echo e(setting()->comp_name); ?>" title="<?php echo e(setting()->comp_name); ?>" class="float-start mb-3" style="max-width: 400px;width: 100%;padding: 0;border: 5px solid #fff;
...
<?php $__currentLoopData = certificates(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
 <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-12">
  <div class="certificate-container">
   <a href="<?php echo e(url('buy-with-confidence/'.$row->slug)); ?>" target="_blank">    
   <div class="certificate-header">
   <h2 class="certificate-title"><?php echo e($row->name); ?></h2>
   </div>
   <div class="certificate-body">
   <h3 class="certificate-name">CMPL</h3>
  <p class="certificate-description"><i class="fad fa-shield-alt fa-2x"></i></p>
  <p class="certificate-date">Issued: <?php echo e(date('d M, Y', strtotime($row->issued_on))); ?></p>
  </div>
  </a>
 </div>
</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u336648322/domains/computronicsmultivision.com/public_html/core/resources/views/about-us.blade.php ENDPATH**/ ?>