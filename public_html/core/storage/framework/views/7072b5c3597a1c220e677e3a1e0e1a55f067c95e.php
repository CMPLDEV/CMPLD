...
<div class="row">
 ...
 <div class="col-lg-3">
<?php if(Auth::guard('admin')->user()->type == "SUPER_ADMIN"): ?>
...
<hr>
<form action="<?php echo e(route('page.bottom.action')); ?>" method="GET" onSubmit="return checkboxValidation()">
 <?php echo csrf_field(); ?> 
...
?>
  <tr>
    ...
    <td><a href="<?php echo e(route('page.update.status',[$row->id,$row_st])); ?>" onClick="return confirm('Are you sure?');"><?php echo statusBadge($row->status); ?></a></td>
    <td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u336648322/domains/computronicsmultivision.com/public_html/core/resources/views/admin/page.blade.php ENDPATH**/ ?>