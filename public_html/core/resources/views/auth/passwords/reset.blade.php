...
@section('title', setting()->comp_name.' | Reset Password')
...
<input type="email" name="email" placeholder="Email" class="form-control @error('email') is-invalid @enderror" value="{{ $email ?? old('email') }}">
@error('email')
