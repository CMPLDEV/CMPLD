...
<div class="card-body">
<form action="{{route('register.otp.verify')}}" class="otp-form" name="otp-form" method="POST">
@csrf 
<div class="title">
<h3><span style="color: red;">OTP </span>VERIFICATION</h3>
<p class="info">An otp has been sent to: {{Session::get('reg_data')['email']}}</p>
...
<p> <a href="{{route('register.otp.resend')}}">Resend verification mail</a> </p>
