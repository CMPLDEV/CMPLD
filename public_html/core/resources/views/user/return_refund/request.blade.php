...
<h4 class="modal-title">Return Request (#{{$order_detail->order_id}})</h4>
...
<div class="row">
 <div class="col-lg-4">
  <a href="{{url($product->slug.'.html')}}" target="_blank">     
 @if(!empty($product))     
  <img src="{{showImage($product->image,'uploaded_files/product')}}" width="200" />    
 @endif
  <p>{{$order_detail->item_name}}</p>
  </a>
 </div>    
 <div class="col-lg-8">
  <div class="row">
