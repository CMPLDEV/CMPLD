...
<div class="row">
<div class="col-lg-3 col-6 mb-2"><a href="{{route('userpanel.order')}}">
<div class="dash-item">
    <span>
...
<div class="col-lg-3 col-6 mb-2"><a href="{{route('userpanel.ticket')}}">
<div class="dash-item">
    <span>
...
<div class="col-lg-3 col-6 mb-2"><a href="{{route('userpanel.profile')}}">
<div class="dash-item">
    <span>
