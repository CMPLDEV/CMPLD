...
<div class="card">
<div class="card-body">
<h5 class="card-title">@isset($edit) Edit @else Add @endisset Offer
<a href="{{route('admin.offer')}}" class="btn btn-info btn-sm float-end text-white">Back</a></h5>

<hr>

<form method="post" enctype="multipart/form-data" @isset($edit) action="{{route('offer.update')}}" @else action="{{route('offer.create')}}" @endisset>
 @csrf
...
<div class="col-lg-2">
 @if(isset($edit) && !empty($edit->image))
  <img src="{{asset(showImage($edit->image,'uploaded_files/offer'))}}" alt="image" width="100%">
...
<div class="col-lg-10">
 ...
 <div class="col-sm-12">
 <div class="form-floating mb-3">
 <input type="text" class="form-control @error('link') is-invalid @enderror" id="floatingInput" name="link" placeholder="Link" @isset($edit) value="{{$edit->link}}" @else value="{{old('link')}}" @endisset>
