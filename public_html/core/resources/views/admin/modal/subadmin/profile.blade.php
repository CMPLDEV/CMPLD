...
<div class="col-lg-6">
 <img @if(!empty($profile->pic)) src="{{asset('uploaded_files/profile/'.$profile->pic)}}" @else src="{{asset('admin_assets/images/user.png')}}" @endif alt="{{ $profile->name }}" class="rounded-circle" width="60">
