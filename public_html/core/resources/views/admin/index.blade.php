...
<h4 class="mt-4 font-weight-bold mb-2 d-flex align-items-center">{{setting()->currency}} &nbsp; <span id="total_sales"> </span> &nbsp; <small class="text-muted" style="font-size:12px;">(Inc. shipping price)</small></h4>
...
<i class="icon nav-icon" data-feather="box"></i> &nbsp; {{$product_count}}
</h4>
</div>
<div>
</div>
...
<h4 class="mt-4 font-weight-bold mb-2 d-flex align-items-center text-muted">
<i class="icon nav-icon" data-feather="mail"></i> &nbsp; {{$enquiry_count}}
</h4>
</div>
<div>
</div>
...
<h4 class="mt-4 font-weight-bold mb-2 d-flex align-items-center text-muted">
<i class="icon nav-icon" data-feather="shopping-cart"></i> &nbsp; {{$order_count}}
</h4>
</div>
<div>
</div>
...
<h4 class="mt-4 font-weight-bold mb-2 d-flex align-items-center text-muted">
<i class="icon nav-icon" data-feather="users"></i> &nbsp; {{$user_count}}
</h4>
</div>
<div>
</div>
